...
public class ExportReport {
    ...
    public static void main(String[] args) throws Exception {
        ...
        builder.writeln("xx银行小微公司授信业务调查报告");
        ...
        builder.writeln("本调查报告作为授信重要决策材料，代表机构贷前调查的尽职调查结果。本机构根据xx银行股份有限公司相关制度和流程，根据借款人、担保人、其他第三方提供的材料并核对了相关原件，复印材料加盖了企业公章，结合机构调查人搜集的其他材料，经机构审慎调查、核实、分析和整理后完成的。报告全面反映了客户的主要信息，机构对报告内容的真实性、准确性、完整性及所作判断的合理性负责，并同意本次授信业务申报方案。");

        // 重置首行缩进为0，如果需要
        builder.getParagraphFormat().setFirstLineIndent(0.0);

        // 添加分页符，确保“一、行业分析”在新的一页
